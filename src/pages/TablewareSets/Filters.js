...
import {TablewareContext} from "../../context/tableware/TablewarePageContext";

export const MenuFilters = () => {
    const {menu_page, setFilters} = React.useContext(TablewareContext)
    ...
    return (
        ...
        <aside className="list__filter-wrapper">
            ...
            <div className="list__filter list__filter__buttons">
                ...
                <button className="clear">сбросить фильтры</button>
            </div>
        </aside>
    )
}
