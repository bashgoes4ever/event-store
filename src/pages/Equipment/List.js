...
import {MenuFiltersMobile} from "./FiltersMobile";
        ...
        <React.Fragment>
            {
                width <= 1260 && filterShow
                    ? (
                        <MenuFiltersMobile></MenuFiltersMobile>
                    )
                    : null
            }
            <section className="list__block1">
                <div className="container">
                    <div className="breadcrumbs">
                        ...
                        <span> | Посуда и оборудование</span>
                    </div>
                    <div className="list__block1__content">
                        ...
                        <main className="list__items-wrapper">
                            <div className="list__items__head equipment__list__head">
                                {
                                    width <= 1260
                                        ? (
                                            <React.Fragment>
                                                <h2>Посуда и оборудование</h2>
                                                <button
                                ...
                                </div>
                                {
                                    width <= 1260
                                        ? (
                                            <button className="remove-filters equipment-remove">сбросить фильтры</button>
