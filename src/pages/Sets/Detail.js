...
export const SetsDetail = () => {
    ...
    const {showLoader, set_detail} = React.useContext(SetDetailContext)
                        ...
                        <div className="set__table">
...

                            {
                                set_detail.categories.map((item, index) => {
                                    return (
                                        <SetDetailCategory key={index} category={item}></SetDetailCategory>
                                    )
                                })
                            }
